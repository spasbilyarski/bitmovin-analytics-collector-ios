...
class EventDataTests: XCTestCase {
    ...
    func testSerializesCorrectly() throws {
        ...
        eventData.deviceInformation = DeviceInformationDto(manufacturer: "Apple", model: "iPhone", isTV: false, operatingSystem: "iOS", operatingSystemMajorVersion: "15", operatingSystemMinorVersion: "2", deviceClass: DeviceClass.Phone, screenHeight: 123, screenWidth: 321)
        eventData.errorCode = 1000
        ...
        eventData.videoBitrate = 48000
        eventData.audioBitrate = 56000
